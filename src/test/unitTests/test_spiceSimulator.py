...
class TestSpiceSimulator(TestCase):
    ...
    def testShouldAddCorrectFooter(self):
        ...
        self.assertEqual(SpiceSimulator.addControl(circuitDescription, "foo.data", [], 100, 1), ".tran 1ms 100ms\n.control\nset filetype=ascii\nrun\nwrdata foo\n.endc\n.end")

    def testShouldAddFooterAddCorrectPlace(self):
        circuitDescription = "Vs VCC GND dc 5V ac 0V\nQa out aBase aEm BC547B\n.model BC547B NPN ()\n.end"
        self.assertEqual(SpiceSimulator.addControl(circuitDescription, "foo,data", [], 100, 1), "Vs VCC GND dc 5V ac 0V\nQa out aBase aEm BC547B\n.model BC547B NPN ()\n.tran 1ms 100ms\n.control\nset filetype=ascii\nrun\nwrdata foo\n.endc\n.end")

    def testShouldAddCorrectSignals(self):
        circuitDescription = "Vs VCC GND dc 5V ac 0V\nQa out aBase aEm BC547B\n.model BC547B NPN ()\n.end"
        self.assertEqual(SpiceSimulator.addControl(circuitDescription, "foo.data", ["v(A)", "i(a)"], 100, 1), "Vs VCC GND dc 5V ac 0V\nQa out aBase aEm BC547B\n.model BC547B NPN ()\n.tran 1ms 100ms\n.control\nset filetype=ascii\nrun\nwrdata foo v(A) i(a)\n.endc\n.end")
