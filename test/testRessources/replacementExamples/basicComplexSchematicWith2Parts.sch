        ...
        <schematic xreflabel="%F%N/%S.%C%R" xrefpart="/%S.%C%R">
            <libraries>
                ...
                <library name="p.peter-test">
                    <packages>
                        <package name="GENERIC_2PIN">
                            <pad name="ANODE" x="-1.27" y="0" drill="0.8" shape="square"/>
                    ...
                    <devicesets>
                        <deviceset name="SIMPLE_LED">
                            ...
                            <devices>
                                <device name="" package="GENERIC_2PIN">
                                    <connects>
            ...
            <parts>
                ...
                <part name="P2" library="p.peter-test" deviceset="SIMPLE_LED" device=""/>
            ...
            <sheets>
                <sheet>
                    ...
                    <instances>
                        ...
                        <instance part="P2" gate="G$1" x="25.4" y="33.02" rot="R270"/>
                        <instance part="P+2" gate="1" x="30.48" y="38.1"/>
                    </instances>
                    <busses>
                    </busses>
                    <nets>
                        <net name="GND" class="0">
                            <segment>
                                ...
                                <pinref part="P2" gate="G$1" pin="CATHODE"/>
                        ...
                        <net name="+5V" class="0">
                            ...
                            <segment>
                                <pinref part="P2" gate="G$1" pin="ANODE"/>
